...
module.exports = function collection(fossa, options) {
  ...
  , id: function id(objectId, fn) {
    ...
    /**
     * Query the collection for models, both live against the database and local
     * cache. Only unique models (by mongoDB ID) are returned.
     *
     * @param {Object} query
  ...
  , where: function where(query, options, fn) {
     ...
     * A local match will be returned directly.
     *
     * @param {Object} query
     * @param {Object} options optional MongoDB options
     * @param {Function} fn callback
