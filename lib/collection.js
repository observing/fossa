...
module.exports = function collection(options) {
  ...
  //
  // Proxy most of MongoDB's collection prototype to our storage prototype.
  // To retain upstream logic, not all methods can be proxied. These are
  // filtered by checking for existing functionality, see above.
  //
