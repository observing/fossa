...
module.exports = function collection(fossa) {
  return backbone.Collection.extend({
    ...
    sync: function sync(method, collection, options) {
      ...
      if ('create' === method) {
        if (collection.any(function anyStored(model) { return model._stored; })) method = 'update';
        if (collection.any(function anyNew(model) { return !model._stored; })) options.upsert = true;
      }
