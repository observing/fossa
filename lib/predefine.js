  ...
  function persist(client, next) {
    ...
    switch (method) {
      ...
      case 'read':
        ...
        //
        // Models will always be fully read by Model id, Collection.fetch
        // however can be passed a query. Get and delete the query from
        // the provided configuration object so it doesn't affect the
        // options passed to the client find.
        //
        if (!single) {
          query = config.query;
          delete config.query;
